...
var createComment = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var validation, _a, news_id, user_id, content, newComment, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                validation = createCommentSchema.safeParse(req.body);
                ...
                _a = validation.data, news_id = _a.news_id, user_id = _a.user_id, content = _a.content;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
