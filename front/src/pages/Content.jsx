...
export default function Content() {
    ...
    useEffect(() => {
        ...
        axios
            .get(`${import.meta.env.VITE_BACKEND_URL}/api/v1/all/news/${id}`  ) // Replace with your actual API URL
            .then((response) => {
        ...
        axios
            .get(`${import.meta.env.VITE_BACKEND_URL}/api/v1/comment/comments/${id}` ) // Adjust endpoint as needed
            .then((response) => {
    ...
    const handlePostComment = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/v1/comment`  , commentData, config);
